...
export default function Form() {
    ...
    return (
        <>
            ...
            >
                <motion.input
                    variants={item} type="text" placeholder="name" {...register("name", {
            ...
            border-solid hover:shadow-glass-sm backdrop-blur-sm text-foreground focus:outline-none focus:ring-2 focus:ring-accent/50 cursor-pointer capitalize' type="submit" />
            </motion.form>
        </>
    );
}